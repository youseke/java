...
public class NewClass {
	...
	public void testFirstAndSecond() {
		try {
			test(new RuntimeException("first"), new RuntimeException("second"),
					null, null);
			fail("Must throw exception");
		} catch (RuntimeException e) {
			assertEquals("first", e.getMessage());
	...
	public void testSecondAndThird() {
		try {
			test(null, new RuntimeException("second"), new RuntimeException(
					"third"), null);
			fail("Must throw exception");
		} catch (RuntimeException e) {
	...
	public void testSecondAndThirdAndFifth() {
		try {
			test(null, new RuntimeException("second"), new RuntimeException(
					"third"), new RuntimeException("fifth"));
			fail("Must throw exception");
		} catch (RuntimeException e) {
			assertEquals("second", e.getMessage());
	...
	public void testThirdAndFifth() {
		try {
			test(null, null, new RuntimeException("third"),
	...
	public void test(RuntimeException first, RuntimeException second,
			RuntimeException third, RuntimeException fifth)
